              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-lg font-bold tabular-nums text-white">{percentage}%</p>
                  </div>
                );
              })}
            </div>
...
function PieChart({
  ...
  const leadingOption = options.reduce(
    (leader, o) => (o.votes > leader.votes ? o : leader),
    options[0]
  );
      ...
      <div className="graph-glow relative rounded-2xl border border-cyan-400/40 bg-slate-900/80 p-5">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <p className="text-4xl font-black tabular-nums text-white">{leadingPercentage}%</p>
            <p className="text-xs tracking-wide text-cyan-200/80">leading</p>
          </div>
        </div>
      </div>
    </div>
